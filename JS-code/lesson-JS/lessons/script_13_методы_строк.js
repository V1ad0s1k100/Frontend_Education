...
console.log(`Длины строки '${messageFormatted.trim()}':  ${messageFormatted.trim().length}`)

// Существуют отдельные методы для обрезки пробелов в начале и в конце строки

console.log(`Длины строки с обрезанными пробелами в начале '${message.trimStart()}':  ${message.trimStart().length}`)

console.log(`Длины строки с обрезанными пробелами в конце '${message.trimEnd()}':  ${message.trimEnd().length}`)
...
const messageForIndex = 'Побробуем найти индекс ~этого выражения~ в этом предложении'

console.log(`Индекс подстроки '~этого выражения~' в строке: ${messageForIndex.indexOf('~этого выражения~')}`)

console.log(`Индекс подстроки 'П' в строке: ${messageForIndex.indexOf('П')}`)

// -1 означает, что такой подстроки в строке нет

console.log(`Индекс подстроки 'фыфыфы' в строке: ${messageForIndex.indexOf('фыфыфы')}`)
...
const messageForReplaceRandomRegister = 'Я изучаю бЭкЕнД, но я еще не изучал бЭкЕнД'
